...
namespace webteste0.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("cliente_id,nome,Email,telefone")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("cliente_id,nome,Email,telefone")] Cliente cliente)
        {
        ...
        {
          return (_context.Cliente?.Any(e => e.cliente_id == id)).GetValueOrDefault();
        }
    }
}
